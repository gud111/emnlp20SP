...
def processDictionaries():
    ...
    inpf = "/home/sdas/cord/covidtweets/panacea/processed/entweets.mallet.in"
    outdir="/home/sdas/cord/covidtweets/panacea/processed"
    stopwordf="/home/sdas/setups/mallet-2.0.8/stoplists/en.txt"
...
def getEmojis(inpf, emojidictf): #, outfforlkup):
...
def splitTweetContent(inpf, emojidictf, slangdictf, outemof, outcontf, outemodictf, outhtlistf):
